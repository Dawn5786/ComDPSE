...
from ltr.dataset import Lasot, Got10k, TrackingNet, MSCOCOSeq, YaoganCutDataset
from ltr.data import processing, sampler, LTRLoader
# from ltr.models.tracking import dimpnet
# from ltr.models.tracking import abspos_dimpnet
from ltr.models.tracking import relativepos_dimpnet
import ltr.models.loss as ltr_losses
import ltr.models.loss.kl_regression as klreg_losses
# import ltr.actors.tracking as tracking_actors
# import ltr.actors.abspos_track as abstrack_actors
import ltr.actors.relativepos_track as relativetrack_actors
from ltr.trainers import LTRTrainer
import ltr.data.transforms as tfm
import ltr.data.transforms_adding as tfm2
...
def run(settings):
    ...
    got10k_val = Got10k(settings.env.got10k_dir)



    # Data transform
    # transform_pos_matrix = tfm.Transform(tfm.ToTensor())
    transform_pos_matrix = tfm2.Transform_Add(tfm2.ToTensor())

    transform_joint = tfm.Transform(tfm.ToGrayscale(probability=0.05),
                                    tfm.RandomHorizontalFlip(probability=0.5))
    # transform_joint = tfm2.Transform(tfm2.ToGrayscale(probability=0.05),
    #                                 tfm2.RandomHorizontalFlip(probability=0.5))
    ...
    trainer.train(62, load_latest=True, fail_safe=True)
